...
namespace UnityEngine.RuntimeSets.Editor
{
	...
	public class RuntimeSetEditor<T> : UnityEditor.Editor where T: MonoBehaviour
	{ 
       ...
       private void OnEnable()
       {
           ...
           if (_runtimeSet == null)
               _runtimeSet = target as RuntimeSet<T>;
       ...
       public override VisualElement CreateInspectorGUI()
       {
           ...
           // ChangeEquipmentInSlot the ListView to the root element
       ...
       private void BindItem(VisualElement element, int index)
       {
           ...
           label.RegisterCallback<MouseDownEvent>(evt =>
           {
               ...
               EditorGUIUtility.PingObject((Object)item);
           });
